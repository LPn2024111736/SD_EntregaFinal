    ...
    def run(self):
        ...
        while not last_request:
            ...
            if self.jogador1.pronto == 1 and self.jogador2.pronto == 1:
                ...
                if self.jogador1.pontuacao >= Servidor.WIN_SCORE or self.jogador2.pontuacao >= Servidor.WIN_SCORE:
                    vencedor = self.jogador1 if self.jogador1.pontuacao >= Servidor.WIN_SCORE else self.jogador2
